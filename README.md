...
以下是当前项目可直接展示的五张系统截图与简要说明：

1. 首页总览页 — 展示学习入口、课程入口与整体系统导航。
2. 资料采集页 — 展示如何导入教材、题库与学习资料。
3. 知识图谱页 — 展示知识点之间的关联与结构化学习路径。
4. 学习统计页 — 展示学生画像、掌握度与弱项分析结果。
5. 命题规律分析页 — 展示命题趋势、题型分布与可视化分析结果。

这些截图可以放在 `docs/screenshots/` 目录中，方便后续直接在 README 中展示系统界面。
